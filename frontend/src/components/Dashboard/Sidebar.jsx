...
const Sidebar = ({ onToggle }) => {
  ...
  const menuItems = [
    { id: 'username', title: 'Profile', description: 'Your profile settings', completed: false },
    { id: 'courses', title: 'Courses', description: 'View your courses', completed: false },
    { id: 'exercises', title: 'Exercises', description: 'Practice exercises', completed: false },
